...
class Stage16QualityReport(Stage):
    ...
    def run(self, context: StageContext) -> StageResult:
        ...
        media_durations = read_payload(context.paths.timeline_media_durations)
        ...
        baseline_leakage_metrics = _quality_baseline_leakage_metrics(context, visual_events)
        ...
        warnings.extend(_presenter_warnings(context, visual_events, chunks, baseline_leakage_metrics))
